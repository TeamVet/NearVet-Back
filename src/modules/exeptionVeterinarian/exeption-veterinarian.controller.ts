...
export class ExeptionVeterinarianController {
  constructor(
    private readonly exeptionVeterinarianService: ExeptionVeterinarianService,
  ) {}

  @Post()
  create(@Body() createExeptionVeterinarianDto: CreateExeptionVeterinarianDto) {
    return this.exeptionVeterinarianService.create(
  ...
  update(
    @Param('id') id: string,
    @Body() updateExeptionVeterinarianDto: UpdateExeptionVeterinarianDto,
  ) {
    return this.exeptionVeterinarianService.update(
      +id,
      updateExeptionVeterinarianDto,
    );
  }
